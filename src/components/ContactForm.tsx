...
export default function ContactForm() {
  ...
  const inputClass =
    'mt-2 w-full rounded-xl border border-white/15 bg-gray-950/60 px-4 py-3 text-white placeholder:text-white/30 outline-none transition focus:border-emerald-300 focus:ring-2 focus:ring-emerald-300/20';
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        <button
          ...
          className="inline-flex h-12 cursor-pointer items-center justify-center rounded-xl bg-white px-7 font-semibold text-gray-950 transition hover:bg-white/80 disabled:cursor-not-allowed disabled:opacity-60"
        >
